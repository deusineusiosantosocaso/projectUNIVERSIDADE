...
import { useGroupings } from '../hooks/useScoutData';
...
const GroupingManager = () => {
    ...
    // Filtragem dos dados
    const filteredData = groupings.filter(item => {
        const matchesSearch = item.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
            item.email.toLowerCase().includes(searchTerm.toLowerCase());
        const matchesRegion = !selectedRegion || item.regionalAdministrationId === selectedRegion;
    ...
    return (
        <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Cards
                    nome="Agrupamentos Ativos"
                    numero={groupings.length}
                    porcent={10}
                    icon="pi pi-sitemap"
                    cor="#4CAF50"
                    corIcon="#FFFFFF"
            ...
            <div className="w-full bg-white mt-10 rounded-lg p-6 space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-gray-900">Gestão de Agrupamentos</h1>
                    <a href="/agrupamento/adicionar">
                                ...
                                {getCurrentItems().map((item) => (
                                    <tr key={item.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div className="text-sm text-gray-500 ">
                                                Fundado em: {new Date(item.foundingDate).toLocaleDateString()}
                                            </div>
                                        </td>
